...
DEGREE_Y = KEY_Y + WHITE_H + 40    # 音级标注（根音/三音/五音/七音）
...
def draw_hand(svg, W, tonic_name, hand):
    ...
    title = f'{tonic_name} Maj7 · {hand["label"]}（{hand["sub"]}）'
    ...
    for rel, finger, side in hand['notes']:
        ...
        deg = {0: '根音', 4: '三音', 7: '五音', 11: '七音'}[rel % 12]
...
def build_single_svg(tonic_name, hand, idx):
    ...
    path = Path(__file__).resolve().parent.parent / 'docs' / 'assets' / 'images' / 'maj7-chords' / f'{tonic_name}-hand-shape-{idx}.svg'
...
if __name__ == '__main__':
    ...
    print('All 36 maj7 SVGs generated!')
