...
大七和弦最常用的场景，是在**主 - 下属**的进行里铺一层柔和的底色。以 C 大调的 **Cmaj7 → Fmaj7 → Cmaj7 → Fmaj7**（1 → 4 → 1 → 4）为例，用手型二弹唱起步：

| 级数 | 和弦 | 手型 | 左手（低→高） | 右手（低→高） |
|------|------|------|--------------|--------------|
| 1 | Cmaj7 | 手型二 | C - C（5-1） | E - G - B（1-2-4） |
| 4 | Fmaj7 | 手型二 | F - F（5-1） | A - C - E（1-2-4） |
| 1 | Cmaj7 | 手型二 | C - C（5-1） | E - G - B（1-2-4） |
| 4 | Fmaj7 | 手型二 | F - F（5-1） | A - C - E（1-2-4） |

> **拆解对照**：Cmaj7 = C + Em（右手 E-G-B 即 Em 原位）、Fmaj7 = F + Am（右手 A-C-E 即 Am 原位）。左右手整体都是「八度根音 + 小三和弦原位」的同一套结构，换和弦时只需把根音 C→F 上行纯四度、右手小三和弦随之平移。
>
